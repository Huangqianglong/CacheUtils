...
public class BlurUti {
    private static final int mShadeColor = 0x00ffffff;

    // int mShadeColor = 0x00ffffff;
    @SuppressLint("NewApi")
...
//        Log.e("pix", w + " " + h + " " + pix.length);
    ...
    public static Bitmap fastBlueBlur(Context context, Bitmap sentBitmap, int radius) {
